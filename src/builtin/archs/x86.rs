...
pub mod machines {
    ...
    x86_machines! {
        pub static {
            ...
            #![x86_32]
            "i386" ["x87", "fsgs"],
            "i486" ["x87", "fsgs", "cx", "cpuid"],
            "i586" ["x87", "cpuid", "fsgs", "cx", "cx8"],
            "pentium" ["x87", "cpuid", "fsgs", "cx", "cx8"],
            "lakemont" ["x87", "cpuid", "fsgs", "cx", "cx8"],
            "pentium-mmx" ["x87", "cpuid", "fsgs", "mmx", "cx", "cx8"],
            "pentiumpro" ["x87", "cpuid", "fsgs", "cx", "cx8"],
            "i686" ["x87", "cpuid", "fsgs", "cx", "cx8"],
            "pentium2" ["x87", "cpuid", "fsgs", "mmx", "fxsr", "cx", "cx8"],
            "petnium3" ["x87", "cpuid", "fsgs", "mmx", "fxsr", "sse", "cx", "cx8"],
            "pentium3m" ["x87", "cpuid", "fsgs", "mmx", "fxsr", "sse", "cx", "cx8"],
            "pentium-m" ["x87", "cpuid", "fsgs", "mmx", "fxsr", "sse", "sse2", "cx", "cx8"],
            "prescott" ["cx8", "cpuid", "fsgs", "cmov", "x87", "mmx", "sse", "sse2", "sse3", "fxsr", "cx", "cx8"],
            "k6" ["x87", "cpuid", "fsgs", "mmx", "cx", "cx8"],
            "k6-2" ["x87", "cpuid", "fsgs", "mmx", "3dnow", "cx", "cx8"],
            "k6-3" ["x87", "cpuid", "fsgs", "mmx", "3dnow", "cx", "cx8"],
            "athlon" ["x87", "cpuid", "fsgs", "mmx", "3dnow", "3dnowa", "cx", "cx8"],
            "althon-third" ["x87", "cpuid", "fsgs", "mmx", "3dnow", "3dnowa", "cx", "cx8"],
            "athlon-4" ["x87", "cpuid", "fsgs", "mmx", "3dnow", "3dnowa", "sse", "cx", "cx8"],
            "athlon-xp" ["x87", "cpuid", "fsgs", "mmx", "3dnow", "3dnowa", "sse", "cx", "cx8"],
            "athlon-mp" ["x87", "cpuid", "fsgs", "mmx", "3dnow", "3dnowa", "sse", "cx", "cx8"],
            #![x86_64]
            "x86-64" ["cx8", "cpuid", "cmov", "x87", "mmx", "sse", "sse2", "fxsr", "cx", "fsgs"],
            "x86-64v2" ["cx8", "cmov", "x87", "mmx", "sse", "sse2", "fxsr", "cx16", "sahf", "sse", "popcnt", "ssse3", "sse4.1", "sse4.2", "cx", "fsgs", "cpuid"],
            "x86-64v3" ["cx8", "cmov", "x87", "mmx", "sse", "sse2", "fxsr", "cx16", "sahf", "sse", "popcnt", "ssse3", "sse4.1", "sse4.2",
                "avx", "avx2", "bmi1", "bmi2", "f16c", "abm", "movbe", "xsave", "cx", "fsgs", "cpuid"],
            "x86-64v4" ["cx8", "cmov", "x87", "mmx", "sse", "sse2", "fxsr", "cx16", "sahf", "sse", "popcnt", "ssse3", "sse4.1", "sse4.2",
                "avx", "avx2", "bmi1", "bmi2", "f16c", "abm", "movbe", "xsave", "avx512f", "avx512bw", "avx512cd", "avx512dq", "avx512vl", "cx", "fsgs", "cpuid"],
            "nocona" ["cx8", "cmov", "x87", "mmx", "sse", "sse2", "sse3", "fxsr", "cx", "fsgs", "cpuid"],
            "core2" ["cx8", "cmov", "x87", "mmx", "sse", "sse2", "sse3", "ssse3", "cx16", "sahf", "fxsr", "cx", "fsgs", "cpuid"],
